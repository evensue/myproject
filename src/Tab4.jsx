  ...
  return (
    <>
           ...
           <div css={contentStyle}>
                ...
                <div css={content}>
                    全方位採集身體動作，實時驅動虛擬形象還原對應的動作效果
                </div>
                
           </div>
            <div css={mimg}><img css={photo} src='https://zego-platform-growth.oss-cn-shanghai.aliyuncs.com/cdn-source/images/virtual-streaming/img_live_characteristic4.png'/></div>
            <div css={connect}>
                    <div>免費試用</div>
                    <div>方案諮詢</div>
