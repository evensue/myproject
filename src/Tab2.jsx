  ...
  return (
    <>
            ...
            <div css={contentStyle}>
                ...
                <div css={content}>
                    精準捕獲面部表情，基於52個基礎表情為杜，實時還原渲染表情隨動效果
                </div>
                
            </div >
                <div css={mimg}><img css={photo} src='https://zego-platform-growth.oss-cn-shanghai.aliyuncs.com/cdn-source/images/virtual-streaming/img_live_characteristic2.png'/></div>
                <div css={connect}>
                    <div>免費試用</div>
                    <div>方案諮詢</div>
                </div>
