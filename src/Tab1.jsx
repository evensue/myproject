  ...
  return (
    <>
            ...
            <article css={contentStyle}>
                ...
                <div css={content}>
                    朔造全新的個性化虛擬形象，自由表達內心情感
                </div>
                
                
            </article>
            <div css={mimg} >
                <img css={photo} src='https://zego-platform-growth.oss-cn-shanghai.aliyuncs.com/cdn-source/images/virtual-streaming/img_live_characteristic1.png'/>
            </div>
            <div css={connect}>
                    <div>免費試用</div>
                    <div>方案諮詢</div>
