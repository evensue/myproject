  ...
  return (
    <>
            ...
            <div css={contentStyle}>
                ...
                <div css={content}>
                    支持20+手勢種類識別，滿足豐富的業務場景
                </div>
                
            </div>
                <div css={mimg}><img css={photo} src='https://zego-platform-growth.oss-cn-shanghai.aliyuncs.com/cdn-source/images/virtual-streaming/img_live_characteristic3.png'/></div>
                <div css={connect}>
                    <div>免費試用</div>
                    <div>方案諮詢</div>
                </div>
